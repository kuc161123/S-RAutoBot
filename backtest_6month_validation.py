#!/usr/bin/env python3
"""
6-MONTH VALIDATION BACKTEST
============================
Validates the current 79-symbol configuration with:
- Exact same logic as live bot (1H divergence + EMA200 + BOS)
- Per-symbol R:R ratios from config.yaml
- Daily/weekly trade frequency metrics
- Monthly breakdown
- Walk-forward validation

Output includes:
- Expected trades per day/week/month
- Monthly P&L breakdown
- Win rate and R metrics
...
print("="*70)
print("6-MONTH VALIDATION BACKTEST")
print("="*70)
