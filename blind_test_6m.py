#!/usr/bin/env python3
"""
6-MONTH BLIND BACKTEST - Current 231 Symbol Configuration
==========================================================
This is a TRUE blind test:
- Uses EXACT config.yaml settings (per-symbol divergence, ATR, RR)
- Fetches 1 year of 1H data (180 days)
...
def fetch_1yr_klines(symbol, days=180):
...
def main():
    print("=" * 70)
    print("6-MONTH BLIND BACKTEST - Current 231 Symbol Configuration")
    print("=" * 70)
    print(f"Started: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    print("Fetching 180 days of 1H data for each symbol...")
    ...
    for symbol, cfg in enabled_symbols.items():
        ...
        df = fetch_1yr_klines(symbol, days=180)
    ...
    print("\n" + "=" * 70)
    print("6-MONTH BLIND BACKTEST RESULTS")
    print("=" * 70)
    ...
    print("SUMMARY")
    print("=" * 70)
    print(f"   Time Period: 6 Months (180 days)")
