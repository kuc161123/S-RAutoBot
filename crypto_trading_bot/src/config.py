...
class Settings(BaseSettings):
    ...
    default_symbols: List[str] = Field(default=[
        ...
        "BSVUSDT", "C98USDT", "CELOUSDT", "CHRUSDT", "CKBUSDT", "COMBOUSDT",
        "CREAMUSDT", "CTCUSDT", "CTXCUSDT", "CVCOINUSDT", "DARUSDT", "DEFIUSDT",
        "DEGOUSDT", "DODOXTUSDT", "DOGSUSDT", "DREPUSDT", "ELFUSDT", "ENJINUSDT",
        "ENSUSDT", "EPSUSDT", "ERNUSDT", "FARMUSDT", "FIDAUSDT", "FLOKIUSDT",
        "FORTHUSDT", "FRONTUSDT", "FTMUSDT", "FUNUSDT", "GALAXYUSDT", "GASUSDT",
        "GLMRUSDT", "GLMUSDT", "GODSUSDT", "GTCUSDT", "HARDUSDT", "HBARUSDT",
        "HIVEUSDT", "HNTUSDT", "HOTCROSSUSDT", "ICPUSDT", "ICXUSDT", "IDEXUSDT",
        "IOTEXUSDT", "IRISUSDT", "JSTUSDT", "KEEPUSDT", "KEYUSDT", "KLAYUSDT",
        "KMDUSDT", "KSMUSDT", "LAZIOUSDT", "LEVERUSDT", "LINAUSDT", "LISUSDT",
        "LITUSDT", "LOOKSUSDT", "LSKUSDT", "MCUSDT", "MDTUSDT", "MDXUSDT",
        "MEMEUSDT", "METISUSDT", "MFTUSDT", "MIRUSDT", "MLNUSDT", "MOBUSDT",
        "MOONUSDT", "MOVRUSDT", "NEXOUSDT", "NFTUSDT", "NUUSDT", "OCEANUSDT",
        "OGFANUSDT", "OMGUSDT", "ONGUSDT", "ORNUSDT", "OXYUSDT", "PAXGUSDT",
        "PEPEUSDT", "PERLUSDT", "PHAUSDT", "PLAUSDT", "PNTUSDT", "POLSUSDT",
        "POLYUSDT", "PORTOUSDT", "PROMMUSDT", "PSGUSDT", "PUNDIXUSDT", "PYRUSDT",
        "QIUSDT", "QUICKUSDT", "RAREUSDT", "RAYUSDT", "REEFUSDT", "RENUSDT",
        "REPUSDT", "RIFUSDT", "RNDRUSDT", "ROCKUSDT", "ROSEUSDT", "ROUTEUSDT"
    ])
