...
class Settings(BaseSettings):
    ...
    default_symbols: List[str] = Field(default=[
        ...
        "IDUSDT", "JOEUSDT", "TLMUSDT", "AMBUSDT", "LEVERUSDT",
        "RDNTUSDT", "HFTUSDT", "XVSUSDT", "EDUUSDT", "IDEXUSDT",
        "SUIUSDT", "1000SHIBUSDT", "1000LUNCUSDT", "ETHWUSDT", "BNXUSDT",
        ...
        "RSRUSDT", "RVNUSDT", "SFPUSDT", "SLPUSDT", "SNTUSDT",
        "STEEMUSDT", "STORJUSDT", "STPTUSDT", "STRAXUSDT", "STRKUSDT",
        "SUNUSDT", "SWEATUSDT", "SYSUSDT", "TOKENUSDT", "TOMIUSDT",
        "TONUSDT", "TRBUSDT", "TRXUSDT", "TWTUSDT", "UMAUSDT",
        "UNFIUSDT", "USDPUSDT", "USTCUSDT", "VGXUSDT", "VIDTUSDT",
        "VITEUSDT", "VOXELUSDT", "VRAUSDT", "WAVESUSDT", "WAXPUSDT",
        "WINUSDT", "XECUSDT", "XEMUSDT", "XMRUSDT", "XNOUSDT",
        "XVGUSDT", "YFIUSDT", "YGGUSDT", "ZENUSDT", "ZILUSDT",
        "ZRXUSDT", "1000BONKUSDT", "1000BTTUSDT", "1000FLOKIUSDT", "1000XECUSDT",
        "ADXUSDT", "AERGOUSDT", "AGIUSDT", "AIOZUSDT", "AKROUSDT",
        "ALCXUSDT", "ALPHAUSDT", "AMPUSDT", "ANCUSDT", "ANTUSDT",
        "API3USDT", "AQUAUSDT", "ARDRUSDT", "ARKMUSDT", "ARPAUSDT",
        "ASRUSDT", "ASTUSDT", "ATAUSDT", "ATPUSDT", "AUDIOUSDT",
        "AURYUSDT", "AVAUSDT", "AXLUSDT", "BADGERUSDT", "BAKEUSDT",
        "BALUSDT", "BANDUSDT", "BARUSDT", "BEAMUSDT", "BELUSDT",
        "BETAUSDT", "BICOUSDT", "BITUSDT", "BKXUSDT", "BLUEBIRDUSDT",
        "BNTUSDT", "BOBAUSDT", "BOMEUSDT", "BSVUSDT", "BSWUSDT",
        "BTGUSDT", "BTRSTUSDT", "BTTUSDT", "BURGERUSDT", "BUSDUSDT"
    ])
